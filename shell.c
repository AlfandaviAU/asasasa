...
#define PATHNAME_BYTE_OFFSET 0x2 
...
#define ROOT_PARENT_FOLDER 0xFF 
#define CHAR_INPUT_NEWLINE CHAR_CARRIAGE_RETURN
#define SECTORS_ENTRY_SIZE 0x10 
#define FILE_SIZE_MAXIMUM (SECTOR_SIZE*SECTORS_ENTRY_SIZE) 
            ...
            default:
                ...
                switch (scancode) {
                    ...
                    case SCANCODE_UP_ARROW:
                        ...
                        print(commands_history+(selected_his_idx*BUFFER_SIZE), 0x7);
                        is_modified = false;
                        break;
